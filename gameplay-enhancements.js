(() => {
  ...
  const introSteps=[
    ...
    {icon:'🧺',title:'Shop and use your items',text:'At the market, choose a department, add groceries to your basket, and pay only at checkout. Bought ingredients become available in your cottage kitchen and bakery.',tip:'Some rooms also let you drag an item into the Use Object area.'},
    {icon:'🦋',title:'Relax in Willow Park',text:'Open the Park from the village map to play Tic-Tac-Toe, Fruit Merge, Color Blocks, Water Sort, Word Finder, Number Merge, or enjoy the animated tea party.',tip:'Life outside the bakery is calm—explore, decorate, and make friends.'},
    {icon:'🍰',title:'Open your bakery',text:'At the front counter, accept a customer’s order. Gather ingredients in the kitchen, use the highlighted stations to cook both items, then return and serve before the three-minute timer ends.',tip:'Poppy’s bakery checklist will stay on screen and can be replayed with the ? button.'}
  ];
