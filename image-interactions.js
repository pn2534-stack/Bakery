(()=>{
  const layouts = {
    ...
    'shops|Pet shop': {
      'Dogs':[4,49,18,29], 'Cats':[29,14,19,30], 'Birds':[79,10,18,31],
      'Rabbits':[43,36,18,27], 'Hamsters':[59,44,15,22], 'Fish tanks':[57,12,21,26],
      'Pet toys':[45,65,17,14], 'Pet beds':[79,64,20,23], 'Pet food':[3,9,23,20],
      'Pet clothing':[7,20,20,25], 'Play area':[26,35,18,24]
    }
  };
